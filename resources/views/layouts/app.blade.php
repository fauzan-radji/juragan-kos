  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="collapseTwo" data-parent="#accordionSidebar" aria-labelledby="headingTwo">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-toggle="collapse" data-target="#collapseUtilities" href="#" aria-expanded="true" aria-controls="collapseUtilities">
      ...
      <li class="nav-item active">
        <a class="nav-link" data-toggle="collapse" data-target="#collapsePages" href="#" aria-expanded="true" aria-controls="collapsePages">
          <i class="fas fa-fw fa-folder"></i>
          <span>Pages</span>
        </a>
        <div class="collapse show" id="collapsePages" data-parent="#accordionSidebar" aria-labelledby="headingPages">
          <div class="bg-white py-2 collapse-inner rounded">
